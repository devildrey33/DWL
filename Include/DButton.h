...
//#pragma once
    ...
    namespace DWL {
		...
		class DButton : public DControlEstandard {
          public: ////////////////////////////////
			virtual const DEnum_Objeto			Objeto_Tipo(void) { return DEnum_Objeto::DEnum_Objeto_Button; };
		  ////////////////////////////////////////
                                                ...
                                                */
												DButton(void) : DControlEstandard() { };
                                                ...
                                                */
			HWND	    					    Crear(DBaseWnd *nPadre, const TCHAR *nTexto, const int cX, const int cY, const int cAncho, const int cAlto, const UINT cID, const DEnum_Button_Tipo TipoBoton = DEnum_Button_Tipo_Normal);
