/*! \file DWL_Compilador_MSC1500.h
	\brief Archivo que proporciona compatibilidad con el compilador Visual Studio 2008 C++.
*/ 

#if _MSC_VER == 1500	
    #ifndef	DWL_COMPILADOR_MSC1500
	    #define DWL_COMPILADOR_MSC1500
...
//		#pragma comment(lib, "Explorerframe.lib")	// Libreria para las extensiones del explorador de windows

        // Definimos macros para funciones basicas dependiendo de si la configuración es UNICODE o ANSI
        #if defined UNICODE
