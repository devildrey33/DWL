========================================================================
    APLICACIÓN DE WIN32: BarraEx Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación BarraEx.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la BarraEx aplicación.
...
small.ico
    ...
    de recursos principal BarraEx.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado BarraEx.pch y un archivo de 
