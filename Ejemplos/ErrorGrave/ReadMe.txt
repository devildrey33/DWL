========================================================================
    APLICACIÓN DE WIN32: ErrorGrave Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación ErrorGrave.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la ErrorGrave aplicación.
...
small.ico
    ...
    de recursos principal ErrorGrave.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado ErrorGrave.pch y un archivo de 
