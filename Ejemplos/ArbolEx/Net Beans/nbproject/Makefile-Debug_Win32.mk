...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug_Win32.mk ../../../Bin/ArbolEx.exe
...
${OBJECTDIR}/_ext/1472/MiArbolEx.o: ../MiArbolEx.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -D_UNICODE -DUNICODE -DDEBUG -D_DEBUG -D_WINDOWS -DWIN32 -I../../../Include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/MiArbolEx.o ../MiArbolEx.cpp

${OBJECTDIR}/_ext/1472/VentanaMain.o: ../VentanaMain.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -D_UNICODE -DUNICODE -DDEBUG -D_DEBUG -D_WINDOWS -DWIN32 -I../../../Include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/VentanaMain.o ../VentanaMain.cpp

${OBJECTDIR}/_ext/1472/stdafx.o: ../stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -D_UNICODE -DUNICODE -DDEBUG -D_DEBUG -D_WINDOWS -DWIN32 -I../../../Include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/stdafx.o ../stdafx.cpp

${OBJECTDIR}/_ext/1472/ArbolEx.o: ../ArbolEx.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -D_UNICODE -DUNICODE -DDEBUG -D_DEBUG -D_WINDOWS -DWIN32 -I../../../Include -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/ArbolEx.o ../ArbolEx.cpp

# Subprojects
.build-subprojects:
	cd ../../../Net\ Beans && ${MAKE}  -f Makefile CONF=Debug
...
# Subprojects
.clean-subprojects:
	cd ../../../Net\ Beans && ${MAKE}  -f Makefile CONF=Debug clean
