========================================================================
    APLICACIÓN DE WIN32: ArbolEx Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación ArbolEx.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la ArbolEx aplicación.
...
small.ico
    ...
    de recursos principal ArbolEx.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado ArbolEx.pch y un archivo de 
