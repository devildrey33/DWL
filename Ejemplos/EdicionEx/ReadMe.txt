========================================================================
    APLICACIÓN DE WIN32: EdicionTextoEx Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación EdicionTextoEx.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la EdicionTextoEx aplicación.


EdicionTextoEx.vcproj
...
small.ico
    ...
    de recursos principal EdicionTextoEx.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado EdicionTextoEx.pch y un archivo de 
