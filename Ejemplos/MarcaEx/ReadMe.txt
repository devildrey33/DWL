========================================================================
    APLICACIÓN DE WIN32: MarcaEx Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación MarcaEx.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la MarcaEx aplicación.
...
small.ico
    ...
    de recursos principal MarcaEx.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado MarcaEx.pch y un archivo de 
