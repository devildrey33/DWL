========================================================================
    APLICACIÓN DE WIN32: LimpiadorProyectos Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación LimpiadorProyectos.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la LimpiadorProyectos aplicación.


LimpiadorProyectos.vcproj
...
small.ico
    ...
    de recursos principal LimpiadorProyectos.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado LimpiadorProyectos.pch y un archivo de 
