========================================================================
    APLICACIÓN DE WIN32: MenuEx Información general del 
    proyecto
========================================================================

AppWizard ha creado esta aplicación MenuEx.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la MenuEx aplicación.
...
small.ico
    ...
    de recursos principal MenuEx.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado MenuEx.pch y un archivo de 
